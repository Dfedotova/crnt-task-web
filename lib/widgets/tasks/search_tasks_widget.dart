...
class SearchTasksWidget extends StatefulWidget {
  const SearchTasksWidget({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _SearchTasksWidgetState();
}

class _SearchTasksWidgetState extends State<SearchTasksWidget> {
